...
export default class PokerPoint implements Wrapper {
  private _wrapper: Wrapper

  constructor(point: number) {
    this._wrapper = new WrapperContainer()
    let _sprite = new Sprite(imagePath.tablePath, `score${point}`)
    this._wrapper.addContainer(_sprite.getContainer())
  }
